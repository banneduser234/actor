...
export default function HomeHero() {
    ...
    // useEffect(() => console.log(categories.data.categories[0]))
    ...
    return (
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        >
          <div
            className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[#1d6f30] to-[#21b042] opacity-20"
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">ACTEURS AGRICOLES DU BENIN</h2>
